...
pub fn main() {
    ...
    let ret = create_grid_extent(-150000.0, -150000.0, 150000.0, 150000.0, 114.0, 40.0, 3000, 3000);

    println!("ret {:?}",ret);
}


fn create_grid_extent(x1:f32,y1:f32,x2:f32,y2:f32,lon0:f32,lat0:f32,row:usize,col:usize)->((f32,f32,f32,f32),(f32,f32),(usize,usize)) {
