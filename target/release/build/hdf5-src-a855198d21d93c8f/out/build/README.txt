...
HDF5 1.10 that was compiled on;
    Linux 4.4.0-18362-Microsoft x86_64, using GNU C 7.5.0.
...
The contents of this directory are:
    ...
    HDF5-1.10.6-Linux.sh    - HDF5 Install Package

Installation
===========================================================================
1. Execute HDF5-1.10.6-Linux.sh
2. Follow prompts
===========================================================================
...
To test the installation with the examples;
    ...
    The default installation folder is defined as "/home/csc/met-io-rs/met-io-rs/target/release/build/hdf5-src-a855198d21d93c8f/out".
