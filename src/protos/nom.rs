    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeFloat>(
                "lat",
                |m: &LatLng| { &m.lat },
                |m: &mut LatLng| { &mut m.lat },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeFloat>(
                "lng",
                |m: &LatLng| { &m.lng },
                |m: &mut LatLng| { &mut m.lng },
            ));
...
impl LatLngBounds {
    ...
    pub fn get__southWest(&self) -> &LatLng {
        self._southWest.as_ref().unwrap_or_else(|| <LatLng as ::protobuf::Message>::default_instance())
    }
    ...
    pub fn get__northEast(&self) -> &LatLng {
        self._northEast.as_ref().unwrap_or_else(|| <LatLng as ::protobuf::Message>::default_instance())
    }
...
impl ::protobuf::Message for LatLngBounds {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    ::protobuf::rt::read_singular_message_into(wire_type, is, &mut self._southWest)?;
                },
                2 => {
                    ::protobuf::rt::read_singular_message_into(wire_type, is, &mut self._northEast)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            let mut fields = ::std::vec::Vec::new();
            fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<LatLng>>(
                "_southWest",
...
impl NomGrid {
    ...
    pub fn get_bounds(&self) -> &LatLngBounds {
        self.bounds.as_ref().unwrap_or_else(|| <LatLngBounds as ::protobuf::Message>::default_instance())
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeFloat>(
                "res",
                |m: &NomGrid| { &m.res },
                |m: &mut NomGrid| { &mut m.res },
            ));
            fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<LatLngBounds>>(
                "bounds",
                |m: &NomGrid| { &m.bounds },
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\tnom.proto\"2\n\x06LatLng\x12\x12\n\x03lat\x18\x01\x20\x01(\x02R\x03l\
    atB\0\x12\x12\n\x03lng\x18\x02\x20\x01(\x02R\x03lngB\0:\0\"d\n\x0cLatLng\
    Bounds\x12(\n\n_southWest\x18\x01\x20\x01(\x0b2\x07.LatLngR\tSouthWestB\
    \0\x12(\n\n_northEast\x18\x02\x20\x01(\x0b2\x07.LatLngR\tNorthEastB\0:\0\
    \"^\n\x07NomGrid\x12\x12\n\x03res\x18\x01\x20\x01(\x02R\x03resB\0\x12'\n\
    \x06bounds\x18\x02\x20\x01(\x0b2\r.LatLngBoundsR\x06boundsB\0\x12\x14\n\
    \x04data\x18\x03\x20\x03(\x02R\x04dataB\0:\0B\0b\x06proto3\
";
